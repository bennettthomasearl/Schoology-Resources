...
Local $sDesiredCapabilities, $sSession, $sPath, $sFile, $sLine, $sCSV, $sFilename, $sArrayNumber, $sResourceTest

$sResourceTest = "Resources"
...
While 1
	...
	;MsgBox($MB_SYSTEMMODAL, "Go to Resources", "//a[contains(text(),'" & $sResourceTest & "')]")
